        ...
        <div class="modal-overlay" @click="$emit('close-updateModal')">
          <div class="modal" @click.stop>
            ...
            <form class="form-style" @submit.prevent="onSubmit">
                <ul>
                    <li>
                        <input type="text" v-if="currentPost" v-model="post.name" class="field-style field-split align-left" placeholder="Name" />
                        <input type="text" v-if="currentPost" v-model="post.email" class="field-style field-split align-right" placeholder="Email" />

                    </li>

                    <li>
                        <textarea v-if="currentPost" v-model="post.content" class="field-style text-area" placeholder="Message" maxlength="1000"></textarea>
                    </li>
